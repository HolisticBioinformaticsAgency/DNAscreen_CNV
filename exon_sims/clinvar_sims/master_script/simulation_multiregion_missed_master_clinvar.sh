...
dnascreen_runs=(6 13 14 18 29 33)
...
padding=0
work_folder_name="_missed" #default is ""

run_dnascreen() {
  local dnascreen_run=$1
  local vcfs_and_bams_dir="${vcfs_and_bams_dir_base}/run${dnascreen_run}"
  missed_cnvs="${sim_dir}/${sim_type}/run${dnascreen_run}/run${dnascreen_run}${work_folder_name}_clinvar.txt"
  ...
  # bed_file="${sim_dir}/bed_files/run${dnascreen_run}${work_folder_name}_clinvar.bed"
